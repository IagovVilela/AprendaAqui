<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
    ...
    <div class="max-w-md w-full space-y-8 relative z-10 animate-fade-in">
        ...
        <div class="text-center animate-slide-down">
            <div class="mx-auto h-20 w-20 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6 shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:scale-105">
            ...
            <p class="text-gray-600 text-lg">Faça login para continuar aprendendo</p>
        </div>
        ...
        <div class="card-glass py-8 px-6 sm:px-8 animate-scale-in">
            <form wire:submit.prevent="login" class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="#" class="text-sm text-blue-600 hover:text-blue-700 font-medium transition-colors hover:underline">
                        Esqueceu a senha?
                    </a>
                </div>
                ...
                <button 
                    type="submit"
                    class="btn-primary w-full flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                    wire:loading.attr="disabled"
                >
                    <div wire:loading wire:target="login" class="animate-spin rounded-full h-5 w-5 border-2 border-white border-t-transparent"></div>
            ...
            <div class="mt-8 pt-6 border-t border-gray-200 text-center">
                <p class="text-gray-600">
                    Não tem uma conta? 
                    <a href="{{ route('register') }}" class="text-blue-600 font-semibold hover:text-blue-700 transition-colors hover:underline inline-flex items-center gap-1">
                        Criar conta
